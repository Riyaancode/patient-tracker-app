...
export default function BottomTabs() {
  return (
    ...
    >
      ...
      <Tab.Screen name="PatientList" component={PatientList} options={{title:"Patient's List"}} />
      <Tab.Screen name="AddAppointment" component={AddAppointment}  options={{title:"Add Patient Details"}} />
