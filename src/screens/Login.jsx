    ...
    return (
        ...
        <ImageBackground style={styles.bg} source={require("../assets/img/bg.png")}>
            <View style={styles.head} >
                ...
                <Text style={styles.desc}>You can search c ourse, apply course and find
            ...
            <ScrollView>
                <View style={styles.section}>
                    <TextInput style={styles.input} value={email} onChangeText={handleEmail} placeholder="Email" />
                </View>
                <View style={styles.section}>
                    <TextInput style={styles.input} value={password} onChangeText={handlePass} textContentType={"password"} secureTextEntry={true} placeholder="Password" />
                </View>
                ...
                <TouchableOpacity onPress={()=> navigation.replace("Signup")}><Text style={{textAlign:'center',color:theme.COLORS.Primary}}>Don’t have an account? Join us</Text></TouchableOpacity>
