        ...
        <ImageBackground style={styles.bg} source={require("../assets/img/bg.png")}>
            ...
            <ScrollView>
                <View style={styles.section}>
                    <TextInput style={styles.input} placeholder="Name" value={name} onChangeText={handleName} />
                </View>
                <View style={styles.section}>
                    <TextInput style={styles.input} placeholder="Email" value={email} onChangeText={handleEmail} />
                </View>
                <View style={styles.section}>
                    <TextInput style={styles.input} textContentType={"password"} value={password} onChangeText={handlePass} secureTextEntry={true} placeholder="Password" />
                </View>
                ...
                <TouchableOpacity onPress={()=>  navigation.navigate("Login")}><Text style={{textAlign:'center',color:theme.COLORS.Primary}}>Have an account? Log in</Text></TouchableOpacity>
            </View>
